...
|----|--------------------------------|------------------------------------------------|------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| 1  | Core Python                    | Zero to Hero • Advanced Python • Best Practices | Syntax → Metaclasses • Decorators • Asyncio • Profiling • Packaging • Type Hints              | [sunny-python-core](https://github.com/sunnypy22/sunny-python-core) | 
